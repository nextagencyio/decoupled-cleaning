...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Sparkle Pro Cleaning. We\'d love to hear from you about scheduling a cleaning or requesting a free estimate.',
  keywords: ['Contact Sparkle Pro Cleaning', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about scheduling a cleaning or requesting a free estimate? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@sparkleprocleaning.com</p>
                    <p className="text-gray-600">support@sparkleprocleaning.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 123-4501</p>
